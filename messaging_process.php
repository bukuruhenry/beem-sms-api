...
$sql_users = mysqli_query($con, "SELECT fullname,phonenumber FROM users"); //Assuming I already have a database with a users table and $con is defined in config.php file
